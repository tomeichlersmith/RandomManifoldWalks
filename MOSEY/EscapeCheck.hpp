...
namespace MOSEY {
	...
	namespace EscapeCheck {
		...
		/**
		 * Defines escape region as the box within the u,v limits input
		 * as parameters.
		 * @param parameters list of the form { umin , umax , vmin , vmax }
		 */
		bool InsideBox(std::vector<double> parameters, StepPtr step);
