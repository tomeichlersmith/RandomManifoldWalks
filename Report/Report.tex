...
\section{Results}
	...
	\subsection{Plane}
		...
		\subsubsection{Ring}
			The averages over the walks show the expected squared dependence that is shown in the analytical solution.
			This specific situation is wildly inefficient; nevertheless, it displays the power of the random walk method.
			This relatively simple computational method allows for determination of numerical solutions to intricate differential equations whose process is easy for the user to understand --- more on this discussion in section \ref{NumericSoln}.
