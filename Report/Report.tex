...
\section{Background}
	...
	\subsection{Charts}
		...
		The only way to arrive at the north pole of $S$ using $\sigma$ is to go out to infinity; thus, another coordinate patch is technically required to define the chart of $S$.
