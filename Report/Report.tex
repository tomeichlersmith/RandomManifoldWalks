...
\section{Results}
	...
	\subsection{Torus}
		\begin{figure*}[htp]
			\centering
			\begin{tabular}{p{0.5\textwidth}p{0.5\textwidth}}
				\includegraphics[width=0.48\textwidth]{images/Torus_U045_055_V0_1_N3000.pdf}
		...
		The walks are assumed to have almost no symmetry involved, so the entire domain of the $\tau$ is studied.
		...
		The placement of this band on torus is not of great importance because of the symmetry in the $v$ coordinate; therefore, we placed the band in the center of the defined domain so the graphic is easier to study.
